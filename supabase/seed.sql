...
BEGIN
    ...
    -- Create some todos
    INSERT INTO todos (user_id, patient_id, titre, description, date_echeance, priorite, type_todo)
    VALUES
        (v_user_id, v_patient_1, 'Rappel bilan allergo', 'Verifier resultats prick tests prevus', CURRENT_DATE + INTERVAL '14 days', 'moyenne', 'rappel'),
        ...
        (v_user_id, NULL, 'Formation DPC', 'Inscription formation pediatrie urgences', CURRENT_DATE + INTERVAL '30 days', 'basse', 'autre');

    RAISE NOTICE 'Seed data created successfully!';
    RAISE NOTICE 'Created 6 patients, 2 consultations, multiple observations, and 5 todos';
END $$;
